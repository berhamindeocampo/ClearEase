...
async function loadRequirements() {
  try {
    const [requirementsResult, submissionsResult, departmentsResult, profileResult, classAssignmentsResult, studentAssignmentsResult, enrolledDepartmentsResult] = await Promise.all([
