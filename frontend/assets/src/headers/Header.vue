...
<template>
  <header class="sticky top-0 z-50 bg-white shadow-[0_2px_8px_rgba(0,0,0,0.05)] border-b border-[#e5e7eb]">
    <div class="max-w-[1500px] mx-auto px-4 md:px-6 py-3">
      <div class="flex items-center justify-between gap-3">
        <div class="flex items-center gap-3 md:gap-5 min-w-0 flex-1">
          <router-link to="/dashboard" class="flex items-center shrink-0 group">
            <img
              :src="cleareaseLogo"
              alt="ClearEase Logo"
